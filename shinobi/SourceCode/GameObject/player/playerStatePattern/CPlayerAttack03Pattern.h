#ifndef CPLAYER_ATTACK03_PATTERN_H_
#define CPLAYER_ATTACK03_PATTERN_H_

#include "CPlayerPattern.h"
#include "CAfterimageEffect.h"

class CPlayer;
class CPlayerAttack03Pattern : public CPlayerPattern
{
public:
	CPlayerAttack03Pattern(CPlayer* , CPlayerPatternManager*);
	~CPlayerAttack03Pattern();
