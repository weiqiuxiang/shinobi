#ifndef CPLAYER_ATTACK04_PATTERN_H_
#define CPLAYER_ATTACK04_PATTERN_H_

#include "CPlayerPattern.h"
#include "CAfterimageEffect.h"

class CPlayer;
class CPlayerAttack04Pattern : public CPlayerPattern
{
public:
	CPlayerAttack04Pattern(CPlayer*,CPlayerPatternManager*);
	~CPlayerAttack04Pattern();
