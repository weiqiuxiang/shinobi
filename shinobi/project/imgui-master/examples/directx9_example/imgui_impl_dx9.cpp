...
bool    ImGui_ImplDX9_Init(void* hwnd, IDirect3DDevice9* device)
{
    ...
    io.RenderDrawListsFn = ImGui_ImplDX9_RenderDrawLists;   // Alternatively you can set this to nullptr and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.
