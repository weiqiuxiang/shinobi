...
#include <stdlib.h>         // nullptr, malloc, free, atoi
...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
            ...
            ImGui::MenuItem("Manipulating window title", nullptr, &show_app_manipulating_window_title);
        ...
        if (ImGui::BeginMenu("Help"))
        {
            ...
            ImGui::MenuItem("About ImGui", nullptr, &show_app_about);
            ImGui::EndMenu();
        }
        ImGui::EndMenuBar();
    }
        ...
        for (int i = 0; i < atlas->Fonts.Size; i++)
        {
            ...
            if (font_details_opened)
            {
                ...
                if (ImGui::TreeNode("Glyphs", "Glyphs (%d)", font->Glyphs.Size))
                {
                    ...
                    const ImFont::Glyph* glyph_fallback = font->FallbackGlyph; // Forcefully/dodgily make FindGlyph() return nullptr on fallback, which isn't the default behavior.
